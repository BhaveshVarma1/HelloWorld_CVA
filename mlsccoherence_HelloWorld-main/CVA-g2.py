...
def stt():
    ...
    with sr.Microphone() as source:
        ...
        try:
            ...
            return "Tell, we are facing some issue"
...
tts("Hey ,I am Tara, VCET's Virtual assistant, to end the call say bye")
while True:
    count += 1
    textInput = stt()
    if "bye" in textInput:
    ...
    last = prompt_parts[-1]
    prompt_parts.pop(-1)
    # prompt_parts[0] = prompt_parts[0] + f"Questions already asked : \"{last}\""
